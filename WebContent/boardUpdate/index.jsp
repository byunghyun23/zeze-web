    ...
    <body>
        <div id = "main">
			...
			<div id = "content" style = "background-color: white; font-size: 1.2rem;">
				<br/>
				<h2 style = "padding: 10px;">수정</h2>
				<br/>
				<hr/ style = "color: 1px solid rgb(219, 217, 245);">
				<br/>
				<form name="postFrm" method="post" action="/s_boardUpdate" enctype="multipart/form-data" >
					<table cellpadding="3" style = "width: 100%; padding: 10px;"> 
						<tr>
							<td>제 목</td>
							<td>
							<input name="subject" size="100" maxlength="50" value="<%=subject%>" style = "border:none;"></td>
						</tr>
						<tr>
							<td>내 용</td>
							<td>
								<textarea id = "editContent" name="content" rows="10" cols="50" style = "width: 90%; height: 500px;"><%=content%></textarea>
                    ...
                    <div style="float: right; padding: 10px;">
                        <a href = "javascript:" onclick="submitContents(this); postFrmCheck();">수 정</a>
                        <div class = "border"> | </div>
                    	<a href = "javascript:" onclick="history.back();">취 소</a>
                    </div>
