...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function findIdFrmCheck() {
                if(findIdFrm.to.value == "") {
                    alert("이메일을 입력해 주세요.");
                    findIdFrm.to.focus();
                }
                else 
            ...
            function findPwFrmCheck() {
                if(findPwFrm.name.value == "") {
                    alert("아이디를 입력해 주세요.");
                    findPwFrm.name.focus();
                }
                else if(findPwFrm.to.value == "") {
                    alert("이메일을 입력해 주세요.");
                    findPwFrm.to.focus();
                }
                else 
                    document.findPwFrm.submit();
            }
        </script>
        <style>
            table {
    ...
    <body>
        ...
        <!-- <a href="mailto:power7339@naver.com">sssss</a> -->
        <div id = "main">
            <div id = "header">
            ...
            <div id = "content" style = "background-color: white; font-size: 1.2rem;">
                <br/>
                <h2 style = "padding: 10px;">아이디 / 비밀번호 찾기</h2>
                <br/>
                <hr/ style = "color: 1px solid rgb(219, 217, 245);">
                <br/>
                <form name = "findIdFrm" action="/sendMail" method="get">
                    <table width="100%">
                        <tr bgcolor="#F5F5F5">
                            <td colspan="3" style = "padding: 1%; font-weight: bold;">이메일 주소로 계정 찾기</td>
                        </tr>
                        <tr>
                            <td width = "10%" style = "padding: 1%;">이메일</td>
                            <td width = "15%" style = "padding: 1%;"><input name = "to" type = "email" maxlength = "40" autocomplete=off style = "width: 100%;" /></td>
                            <td width = "40%" style = "padding: 1%;">정확하게 입력해주세요.</td>
                        </tr>
                    </table>
                    <div class = "right">
                        <div style = "display: inline;"><a href = "javascript:" onclick = "findIdFrmCheck();" style = "letter-spacing: 3px; ">계정 찾기</a></div>
                    </div>
                    <input type="hidden" name="subject" value = "계정 찾기"/>
                    <!-- <input type="hidden" name="from" value = "power7339@naver.com"/> -->
                </form>

                <form name = "findPwFrm" action="/sendMail" method="get">
                    <table width="100%">
                        <tr bgcolor="#F5F5F5">
                            <td colspan="3" style = "padding: 1%; font-weight: bold;">계정과 이메일 주소로 비밀번호 찾기</td>
                        </tr>
                        <tr>
                            <td width = "10%" style = "padding: 1%;">아이디</td>
                            <td width = "15%" style = "padding: 1%;"><input name = "name" type = "text" maxlength = "20" autocomplete=off style = "width: 100%;" /></td>
                            <td width = "40%" style = "padding: 1%;">정확하게 입력해주세요.</td>
                        </tr>
                        <tr>
                            <td width = "10%" style = "padding: 1%;">이메일</td>
                    ...
                    <div class = "right">
                        <div style = "display: inline;"><a href = "javascript:" onclick = "findPwFrmCheck();" style = "letter-spacing: 3px; ">비밀번호 찾기</a></div>
                    </div>
